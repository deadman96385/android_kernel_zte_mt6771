...
static void set_dummy(void)
{
	...
	LOG_INF("0x05 = %x\n",read_cmos_sensor(0x05));
	LOG_INF("0x06 = %x\n",read_cmos_sensor(0x06));
	LOG_INF("set_dummy_new\n");
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch (image_mirror) {
        case IMAGE_NORMAL:
            write_cmos_sensor(0x3820,((read_cmos_sensor0(0x3820) & 0xF9) | 0x00));
            write_cmos_sensor(0x3821,((read_cmos_sensor0(0x3821) & 0xF9) | 0x06));
            break;
        case IMAGE_H_MIRROR:
            write_cmos_sensor(0x3820,((read_cmos_sensor0(0x3820) & 0xF9) | 0x00));
            write_cmos_sensor(0x3821,((read_cmos_sensor0(0x3821) & 0xF9) | 0x00));
            break;
        case IMAGE_V_MIRROR:
            write_cmos_sensor(0x3820,((read_cmos_sensor0(0x3820) & 0xF9) | 0x06));
            write_cmos_sensor(0x3821,((read_cmos_sensor0(0x3821) & 0xF9) | 0x06));
            break;
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xfd,0x01);
	write_cmos_sensor(0x3f,0x03);//sanford.lin mirror
