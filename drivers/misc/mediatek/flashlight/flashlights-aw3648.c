...
/* define level */
#define AW3648_LEVEL_NUM 18
#define AW3648_LEVEL_TORCH 6
...
static const int aw3648_current[AW3648_LEVEL_NUM] = {
	52, 98, 145, 186, 279, 372,
	421, 539, 656, 750, 820, 937, 1008, 1101, 1219, 1312, 1406, 1500
};

static const unsigned char aw3648_flash_level[AW3648_LEVEL_NUM] = {
	0x88, 0x90, 0x98, 0x9f, 0xaf, 0xbf,
	0x91, 0x96, 0x9b, 0x9f, 0xa2, 0xa7, 0xaa, 0xae, 0xb3, 0xb7, 0xbb, 0xbf
};
	...
	case FLASH_IOC_SET_ONOFF:
		...
		if (fl_arg->arg == 1) {
			if (aw3648_timeout_ms) {
				ktime = ktime_set(aw3648_timeout_ms / 1000,
						(aw3648_timeout_ms % 1000) * 1000000);
