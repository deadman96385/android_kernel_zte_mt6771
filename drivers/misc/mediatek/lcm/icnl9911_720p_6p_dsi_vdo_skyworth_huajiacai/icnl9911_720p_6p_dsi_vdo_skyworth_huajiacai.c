...
{
	LCM_LOGI("%s: kernel ----icnl9911_720p_6p_dsi_vdo_skyworth_huajiacai_drv----\n", __func__);
...
LCM_DRIVER icnl9911_720p_6p_dsi_vdo_skyworth_huajiacai_lcm_drv = {
	.name = "icnl9911_720p_6p_dsi_vdo_skyworth_huajiacai_drv",
