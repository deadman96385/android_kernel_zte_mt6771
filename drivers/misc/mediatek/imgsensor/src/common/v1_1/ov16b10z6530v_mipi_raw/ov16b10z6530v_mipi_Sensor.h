 ...
 *
 ****************************************************************************/
#ifndef _OV16B10MIPI_SENSOR_H
#define _OV16B10MIPI_SENSOR_H
...
struct imgsensor_info_struct {
	...
	/* 0, high speed signal auto detect; 1, use settle delay,unit is ns, default is auto detect */
...
extern int iReadRegI2C(u8 *a_pSendData, u16 a_sizeSendData, u8 *a_pRecvData, u16 a_sizeRecvData,
		       u16 i2cId);
extern int iReadRegI2CTiming(u8 *a_pSendData, u16 a_sizeSendData, u8 *a_pRecvData,
