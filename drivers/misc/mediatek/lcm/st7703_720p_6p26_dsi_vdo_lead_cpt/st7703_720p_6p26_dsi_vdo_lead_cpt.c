...
static struct LCM_setting_table init_setting[] = {
	...
	{0xcc, 1, {0x0b} },
	{0xb4, 1, {0x80} },
	{0xb1, 4, {0x85, 0x00, 0x00, 0x01} },
	{0xb2, 3, {0x04, 0x02, 0x30} },
	{0xe3, 14, {0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x00, 0x00, 0x00, 0x00, 0x2f, 0x00, 0xc0, 0x10} },
	{0xc1, 12, {0x54, 0xc0, 0x2a, 0x2a, 0x99, 0xd1, 0xff, 0xff, 0xae, 0xae, 0x7f, 0x7f} },
	{0xc6, 6, {0x01, 0x0c, 0xff, 0xff, 0x00, 0x20} },
	{0xb5, 2, {0x19, 0x19} },
	{0xb6, 2, {0x43, 0x43} },
	{0xbf, 3, {0x02, 0x11, 0x00} },
	{0xe9, 63, {0x02, 0x00, 0x18, 0x06, 0x0d, 0x80, 0x81, 0x12, 0x31, 0x23,
				0x5f, 0x1b, 0x30, 0xb1, 0x37, 0x0a, 0x00, 0x80, 0x02, 0x00,
				0x00, 0x00, 0x00, 0x80, 0x02, 0x00, 0x00, 0x00, 0x84, 0xf0,
				0x24, 0x68, 0x88, 0x88, 0x88, 0x80, 0x88, 0x88, 0x88, 0x85,
				0xf1, 0x35, 0x78, 0x88, 0x88, 0x88, 0x81, 0x88, 0x88, 0x88,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00} },
	{0xea, 61, {0x00, 0x1a, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00,
				0x00, 0x00, 0xf1, 0x87, 0x53, 0x18, 0x88, 0x88, 0x88, 0x85,
				0x88, 0x88, 0x88, 0xf0, 0x86, 0x42, 0x08, 0x88, 0x88, 0x88,
				0x84, 0x88, 0x88, 0x88, 0x23, 0x20, 0x00, 0x00, 0x24, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x50, 0x80, 0x81, 0x00, 0x00, 0x00,
				0x00} },
	{0xe0, 34, {0x00, 0x0F, 0x1A, 0x32, 0x3F, 0x3F, 0x53, 0x46, 0x08, 0x0E,
				0x0E, 0x11, 0x13, 0x11, 0x13, 0x12, 0x19, 0x00, 0x0F, 0x1A,
				0x32, 0x3F, 0x3F, 0x53, 0x46, 0x08, 0x0E, 0x0E, 0x11, 0x13,
				0x11, 0x13, 0x12, 0x19} },
	{0xef, 3, {0xff, 0xff, 0x01} },
	{0xc7, 1, {0xb0} },
	{0xc8, 3, {0x10, 0x01, 0x02} },
	{0x51, 1, {0x00} },
	{0x53, 1, {0x24} },
	{0x55, 1, {0x00} },
	{0x5e, 1, {0x04} },
...
static struct LCM_setting_table init_setting2[] = {
	{0xb9, 3, {0xf1, 0x12, 0x83} },
	{0xba, 27, {0x32, 0x81, 0x05, 0xf9, 0x0e, 0x0e, 0x20, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x00, 0x00, 0x44, 0x25, 0x00, 0x91, 0x0a, 0x00,
				0x00, 0x00, 0x4f, 0x01, 0x00, 0x00, 0x37} },
	{0xb8, 4, {0x76, 0x22, 0x20, 0x03} },
	{0xb3, 10, {0x0c, 0x10, 0x05, 0x05, 0x03, 0xff, 0x00, 0x00, 0x00, 0x00} },
	{0xc0, 9, {0x73, 0x73, 0x50, 0x50, 0xa0, 0x00, 0x08, 0x70, 0x00} },
	{0xbc, 1, {0x4f} },
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_frontporch = 108;
...
#else
	params->dsi.PLL_CLOCK = 369;	/* this value must be in MTK suggested table */
#endif
	params->dsi.PLL_CK_CMD = 240;
	params->dsi.PLL_CK_VDO = 369;
#else
...
{
	LCM_LOGI("%s: kernel ----st7703_720p_6p26_dsi_vdo_lead_cpt_drv----\n", __func__);
...
LCM_DRIVER st7703_720p_6p26_dsi_vdo_lead_cpt_lcm_drv = {
	.name = "st7703_720p_6p26_dsi_vdo_lead_cpt_drv",
