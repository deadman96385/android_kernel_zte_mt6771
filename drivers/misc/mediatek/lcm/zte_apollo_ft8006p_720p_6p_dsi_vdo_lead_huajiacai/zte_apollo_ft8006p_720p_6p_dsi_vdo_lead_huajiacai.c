...
{
	LCM_LOGI("%s: kernel ----zte_apollo_ft8006p_720p_6p_dsi_vdo_lead_huajiacai_drv----\n", __func__);
...
LCM_DRIVER zte_apollo_ft8006p_720p_6p_dsi_vdo_lead_huajiacai_lcm_drv = {
	.name = "zte_apollo_ft8006p_720p_6p_dsi_vdo_lead_huajiacai_drv",
