...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch = 52;
...
{
	LCM_LOGI("%s: kernel ----ili9881c_720p_6p26_dsi_vdo_skyworth_qc_drv----\n", __func__);
...
LCM_DRIVER ili9881c_720p_6p26_dsi_vdo_skyworth_qc_lcm_drv = {
	.name = "ili9881c_720p_6p26_dsi_vdo_skyworth_qc_drv",
