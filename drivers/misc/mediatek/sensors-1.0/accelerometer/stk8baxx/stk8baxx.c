...
static long stk_fops_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case GSENSOR_IOCTL_READ_CHIPINFO:
		...
		snprintf(strbuf, STK_BUFSIZE, "STK832x Chip");
	...
	case GSENSOR_IOCTL_READ_SENSORDATA:
		...
		snprintf(strbuf, STK_BUFSIZE, "%04x %04x %04x", stk->xyz[0], stk->xyz[1], stk->xyz[2]);
...
*/
	...
	snprintf(buff, STK_BUFSIZE, "%04x %04x %04x",
