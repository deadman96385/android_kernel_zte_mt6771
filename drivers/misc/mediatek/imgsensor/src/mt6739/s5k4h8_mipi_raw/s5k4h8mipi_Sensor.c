...
extern bool otp_update_s5k4h8(void);
...
static imgsensor_info_struct imgsensor_info = {
	...
	static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
		...
		{ 3264, 2448,    0,  0, 3264, 2448, 1632,  1224, 0000, 0000, 1632, 1224, 0,  0, 1632,  1224},
		{ 3264, 2448,    0,  0, 3264, 2448,  816,   612, 0000, 0000,  816,  612, 0,  0,  816,   612},
		{ 3264, 2448,    0,  306, 3264, 1836, 1280,   720, 0000, 0000, 1280,  720, 0,  0, 1280,   720},
		{ 4192, 3104,    0,  0, 4192, 3104, 2096,  1552, 0000, 0000, 2096, 1552, 0,  0, 2096,  1552},
		{ 4192, 3104,    0,  0, 4192, 3104, 2096,  1552, 0000, 0000, 2096, 1552, 0,  0, 2096,  1552},
		{ 4192, 3104,    0,  0, 4192, 3104, 2096,  1552, 0000, 0000, 2096, 1552, 0,  0, 2096,  1552},
		{ 4192, 3104,    0,  0, 4192, 3104, 2096,  1552, 0000, 0000, 2096, 1552, 0,  0, 2096,  1552},
		{ 4192, 3104,    0,  0, 4192, 3104, 2096,  1552, 0000, 0000, 2096, 1552, 0,  0, 2096,  1552},
	...
	*************************************************************************/
	static void sensor_init(void)
	{
		...
		if (chip_id == 0xb001) {
			...
			write_cmos_sensor(0x6F12, 0x7970);
...
/********************************************************************************************************************
$MIPI[Width:2096,Height:1552,Format:RAW10,Lane:4,ErrorCheck:0,PolarityData:0,
PolarityClock:0,Buffer:4,DataRate:1260,useEmbData:0]
$MV1[MCLK:24,Width:2096,Height:1552,Format:MIPI_RAW10,mipi_lane:4,
mipi_datarate:1260,pvi_pclk_inverse:0]
=====================================================
4H8XXM
...
static void preview_setting(void)
{
		...
		if (chip_id == 0xb001) {
			...
			write_cmos_sensor_8(0x6F12, 0x01);
			if (imgsensor.ihdr_en) {
				write_cmos_sensor(0x0216, 0x0201);
			} else {
...
/*  preview_setting  */
/******************************************************************************************************************
$MIPI[Width:4192,Height:3104,Format:RAW10,Lane:4,ErrorCheck:0,PolarityData:0,
PolarityClock:0,Buffer:4,DataRate:1260,useEmbData:0]
...
static void normal_capture_setting(void)
{
		...
		if (chip_id == 0xb001) {
			...
			write_cmos_sensor(0x602A, 0x034A);
			write_cmos_sensor(0x6F12, 0x0997);
			write_cmos_sensor(0x6F12, 0x0CC0);
			write_cmos_sensor(0x6F12, 0x0990);
			write_cmos_sensor(0x602A, 0x0342);
			write_cmos_sensor(0x6F12, 0x0EA0);
			write_cmos_sensor(0x602A, 0x0340);
...
/******************************************************************************************************************
$MIPI[Width:4192,Height:3104,Format:RAW10,Lane:4,ErrorCheck:0,
PolarityData:0,PolarityClock:0,Buffer:4,DataRate:1260,useEmbData:0]
$MV1[MCLK:24,Width:4192,Height:3104,Format:MIPI_RAW10,mipi_lane:4,
mipi_datarate:1260,pvi_pclk_inverse:0]
=====================================================
4H8XXM
Full Resolution normal Mode
...
/********************************************************************************************************************
$MIPI[Width:688,Height:512,Format:RAW10,Lane:4,ErrorCheck:0,
PolarityData:0,PolarityClock:0,Buffer:4,DataRate:1260,useEmbData:0]
...
/*****************************************************************************************************************
$MIPI[Width:1280,Height:720,Format:RAW10,Lane:4,ErrorCheck:0,PolarityData:0,
PolarityClock:0,Buffer:4,DataRate:1260,useEmbData:0]
$MV1[MCLK:24,Width:1280,Height:720,Format:MIPI_RAW10,
mipi_lane:4,mipi_datarate:1260,pvi_pclk_inverse:0]
=====================================================
4H8XX EVT 2.0
...
case MSDK_SCENARIO_ID_CUSTOM1:
	...
	10 / imgsensor_info.custom1.linelength;
	spin_lock(&imgsensor_drv_lock);
