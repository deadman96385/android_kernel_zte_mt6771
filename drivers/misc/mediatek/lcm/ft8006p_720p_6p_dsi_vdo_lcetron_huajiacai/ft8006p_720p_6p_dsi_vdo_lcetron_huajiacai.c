...
{
	LCM_LOGI("%s: kernel ----ft8006p_720p_6p_dsi_vdo_lcetron_huajiacai_drv----\n", __func__);
...
LCM_DRIVER ft8006p_720p_6p_dsi_vdo_lcetron_huajiacai_lcm_drv = {
	.name = "ft8006p_720p_6p_dsi_vdo_lcetron_huajiacai_drv",
