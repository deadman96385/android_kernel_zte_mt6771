...
#define VENDOR_ID1	0xf7
#define VENDOR_ID2	0x7f
#define VENDOR_ID3	0x00
#define VENDOR_ID4	0x00

#define CTS_VENDOR1_NAME		"Skyworth"
#define CTS_VENDOR2_NAME		"Skyworth"
#define CTS_VENDOR3_NAME		"unknown"
