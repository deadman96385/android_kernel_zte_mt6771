...
/*HM*/
UINT32 HM1062_MIPI_MONO_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 HM1062_2_MIPI_MONO_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
/*IMX*/
UINT32 IMX576_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 IMX350_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 IMX386_MIPI_MONO_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 IMX376_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV9282_2MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV13855MAIN2_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV2281_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 OV20880_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
UINT32 S5K3P8SP_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
