...
#define FTS_MAX_EDGE_LIMIT_WIDTH	10
...
#define FT5X46_TEST     0x01
#define FT6X36_TEST     0x02
...
struct fts_ts_data {
	...
	struct regulator *ldo_avdd;
	struct regulator *ldo_iovdd;
	spinlock_t irq_lock;
	...
	struct pinctrl_state *pinctrl_int_input;
...
#endif
	int fb_tpd_suspend_flag;
	struct work_struct fb_tpd_resume_work;
	struct workqueue_struct *fb_tpd_resume_wq;
};
