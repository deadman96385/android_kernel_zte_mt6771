...
{
	LCM_LOGI("%s: kernel ----zte_durian_ft8006p_720p_6p49_dsi_vdo_dijing_huajiacai_drv----\n", __func__);
...
LCM_DRIVER zte_durian_ft8006p_720p_6p49_dsi_vdo_dijing_huajiacai_lcm_drv = {
	.name = "zte_durian_ft8006p_720p_6p49_dsi_vdo_dijing_huajiacai_drv",
