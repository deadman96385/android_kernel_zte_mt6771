...
{
	LCM_LOGI("%s: kernel ----icnl9911_720p_6p_dsi_vdo_skyworth_huajiaca_4lanei_drv----\n", __func__);
...
{
	LCM_LOGI("%s: kernel----icnl9911_720p_6p_dsi_vdo_skyworth_huajiacai_4lane_drv----\n", __func__);
	lcm_init();
}
...
LCM_DRIVER icnl9911_720p_6p_dsi_vdo_skyworth_huajiacai_4lane_lcm_drv = {
	.name = "icnl9911_720p_6p_dsi_vdo_skyworth_huajiacai_4lane_drv",
