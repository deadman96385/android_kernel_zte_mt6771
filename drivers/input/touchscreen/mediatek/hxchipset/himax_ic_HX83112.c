...
static void hx83112a_read_ic_ver(void)
{
	...
	if ((tmp_data[0] == 0x44) || (tmp_data[0] == 0x77)) {
...
static void hx83112_dynamic_fw_name(uint8_t ic_name)
{
	...
	if (ic_data->vendor_ic_ver == 0x44) { /* Cut 1 */
		memcpy(firmware_name, "Himax_firmware_1.bin", sizeof(char)*strlen("Himax_firmware_1.bin"));
	} else if (ic_data->vendor_ic_ver == 0x77) { /* Cut 2 */
		memcpy(firmware_name, "Himax_firmware_2.bin", sizeof(char)*strlen("Himax_firmware_2.bin"));
	} else if ((ic_data->vendor_ic_ver == 0x03) || (ic_data->vendor_ic_ver == 0x13) || (ic_data->vendor_ic_ver == 0x23)) { /* Cut 3 */
		memcpy(firmware_name, "Himax_firmware_3.bin", sizeof(char)*strlen("Himax_firmware_3.bin"));
	} else if ((ic_data->vendor_ic_ver == 0x04) || (ic_data->vendor_ic_ver == 0x14)) { /* Cut 4 */
		memcpy(firmware_name, "Himax_firmware_4.bin", sizeof(char)*strlen("Himax_firmware_4.bin"));
	} else { /* Original */
