...
static int expired_policy_en_set(const char *val, struct kernel_param *kp)
{
	int rc;
...
static int expired_policy_en_get(char *val, struct kernel_param *kp)
{
...
static int policy_lowtemp_en_set(const char *val, struct kernel_param *kp)
{
	int rc;
...
static int policy_lowtemp_en_get(char *val, struct kernel_param *kp)
{
...
static int policy_cap_min_set(const char *val, struct kernel_param *kp)
{
	int rc;
...
static int policy_cap_min_get(char *val, struct kernel_param *kp)
{
...
static int policy_cap_max_set(const char *val, struct kernel_param *kp)
{
	int rc;
...
static int policy_cap_max_get(char *val, struct kernel_param *kp)
{
...
static int set_enable_to_dump_reg(const char *val, struct kernel_param *kp)
{
	int ret = 0;
