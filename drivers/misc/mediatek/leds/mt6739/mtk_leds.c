...
#define PMIC_PERIOD_NUM 10

int pmic_period_array[] = { 2, 4, 6, 8, 10, 12, 20, 60, 3500, 5000 };
int pmic_freqsel_array[] = { 0, 1, 2, 3, 4, 5, 9, 28, 1749, 2499 };
...
int mt_brightness_set_pmic(enum mt65xx_led_pmic pmic_type, u32 level, u32 div)
{
	...
	if (pmic_type == MT65XX_LED_PMIC_NLED_ISINK0) {
#if defined(CONFIG_MTK_PMIC_CHIP_MT6357) && defined(CONFIG_ZTE_USE_CHRIND_LED)
	if (level) {
		pmic_set_register_value(PMIC_CHRIND_EN_SEL, 0);
