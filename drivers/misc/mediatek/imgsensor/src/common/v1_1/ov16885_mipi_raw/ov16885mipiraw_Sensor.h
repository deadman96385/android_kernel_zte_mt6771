 ...
 *
 ****************************************************************************/
#ifndef __OV16885MIPI_SENSOR_H__
#define __OV16885MIPI_SENSOR_H__
...
typedef struct imgsensor_struct {
	...
	kal_uint32 dummy_pixel;	/* current dummypixel */
...
typedef struct imgsensor_info_struct {
	...
	imgsensor_mode_struct cap1;	/* capture for PIP 24fps relative information,
					 ...
					 */
	imgsensor_mode_struct cap2;	/* capture for PIP 24fps relative information,
					 * capture1 mode must use same framelength,
					 * linelength with Capture mode for shutter calculate
					 */
	...
	kal_uint8 frame_time_delay_frame;	/* The delay frame of setting frame length lzl */
	...
	kal_uint8 mipi_sensor_type;	/* 0,MIPI_OPHY_NCSI2; 1,MIPI_OPHY_CSI2, default is NCSI2,
