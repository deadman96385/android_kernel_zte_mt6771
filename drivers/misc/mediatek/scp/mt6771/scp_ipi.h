...
#define SCP_IPI_ID_STAMP_SIZE 5
	unsigned long long recv_timestamp[SCP_IPI_ID_STAMP_SIZE]; /*recv_flag[recv_count] recv_timestamp[Timestamp]*/
	unsigned long long handler_timestamp[SCP_IPI_ID_STAMP_SIZE]; /*recv_flag[recv_count] recv_timestamp[Timestamp]*/
	unsigned long long send_timestamp[SCP_IPI_ID_STAMP_SIZE]; /*send_flag[send_count] send_timestamp[Timestamp]*/
